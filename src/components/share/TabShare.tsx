...
const TabShare = () => {
  ...
  const whatsappMessage = encodeURIComponent(
    "I found this useful paint calculator tool, check it out: https://seosaurus.in/tools/paint-calculator/"
  );

  const toolUrl = "https://seosaurus.in/tools/paint-calculator/";
